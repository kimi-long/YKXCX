		...
		<view class="teacherDetail">
			<view class="teacherTop">
				...
				<view class="teacherCard">
					...
					<view class="teacherName">{{teacherInfo.StoresName}}</view>
					<!-- <view class="teacherTitle">{{teacherInfo.Title}}</view> -->
				</view>
				<view class="teacherIntro">
					<view>
						门店电话：{{teacherInfo.StoresPhone}}
					</view>
					<view>
						门店地址：{{teacherInfo.Address}}
					</view>
				</view>
			</view>
			<view class="teacherMid">
				<view class="teacherMidTitle">门店简介</view>
				<view style="padding: 0 20px 20px;">
					<u-parse :content="teacherInfo.StoresInfo" :className='Chtml'/>
				</view>
...
<script>
	...
	import {
		getTeacherDetail,
		addEvaluateTeacher,getStoresDetails
...
<style lang="less">
	.themegreen .teacherDetail .teacherTop .teacherIntro{
